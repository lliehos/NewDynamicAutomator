...
namespace Morobot.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260925213058_PlanSourceRowByteCaps")]
    partial class PlanSourceRowByteCaps
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Morobot.Domain.Entities.Plan", b =>
                {
                    ...
                    b.Property<long?>("MaxSourceBytes")
                        .HasColumnType("bigint");

                    b.Property<int?>("MaxSourceRows")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Morobot.Domain.Entities.ProcessTemplate", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Morobot.Domain.Entities.StoredLicense", b =>
                {
                    ...
                    b.Property<bool>("AllowLegacyMigration")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("ReferralWidgetUrl")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("Morobot.Domain.Entities.DataSourceCell", b =>
                {
                    ...
                    b.HasOne("Morobot.Domain.Entities.AppUser", null)
                        .WithMany()
                        .HasForeignKey("LastEditorUserId")
            ...
            modelBuilder.Entity("Morobot.Domain.Entities.Process", b =>
                {
                    ...
                    b.HasOne("Morobot.Domain.Entities.ProcessTemplate", "Template")
                        .WithMany("Processes")
